...
@app.route('/')
def home():
    return "ɪ'ᴀᴍ ᴩʀɪʏᴀɴꜱʜᴜ ꜰɪʟᴇ ʜᴏꜱᴛ ꜱᴇʀᴠᴇʀ "
...
def keep_alive():
    ...
    t.start()
    print("ꜰʟᴀꜱᴋ ᴋᴇᴇᴘ-ᴀʟɪᴠᴇ ꜱᴇʀᴠᴇʀ ꜱᴛᴀʀᴛᴇᴅ.")
# --- End Flask Keep Alive ---

# --- Configuration ---
TOKEN = os.environ.get('BOT_TOKEN')  # Railway ke "Variables" tab se set karo
OWNER_ID = int(os.environ.get('OWNER_ID', '0'))  # Railway ke "Variables" tab se set karo
ADMIN_ID = int(os.environ.get('ADMIN_ID', '0'))  # Railway ke "Variables" tab se set karo
YOUR_USERNAME = '@Vortex_priyanshu' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/NullByte_forget' # Replace with your update channel link
