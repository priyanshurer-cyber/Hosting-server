...
@app.route('/')
def home():
    return "🤖 @Vortex_priyanshu  🦁 𝐢𝐬 𝐑𝐮𝐧𝐧𝐢𝐧𝐠!"
@app.route('/health')
def health():
...
# --- Configuration ---
TOKEN = '8654744585:AAEhhNGvXz6_LN54yHntcqUaWxSOBZTOxrc'
OWNER_ID = 8978106847
ADMIN_ID = 8978106847
YOUR_USERNAME = '@Vortex_priyanshu '
UPDATE_CHANNEL = 'https://t.me/NullByte_forget'
...
"""
            ...
            message = f"""
⚠️ ᴩʀɪʏᴀɴꜱʜᴜ 𝐀𝐮𝐭𝐨-𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐅𝐚𝐢𝐥𝐞𝐝
📄 𝐅𝐢𝐥𝐞: {file_name}
...
def cleanup_on_exit():
    ...
    logger.info(apply_custom_font("Cleaning up ᴩʀɪʏᴀɴꜱʜᴜ..."))
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("🤖 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 ᴩʀɪʏᴀɴꜱʜᴜ 🦁 𝐁𝐨𝐭...")
    ...
    while True:
        try:
            ...
            logger.error(f"ᴩʀɪʏᴀɴꜱʜᴜ 𝐞𝐫𝐫𝐨𝐫: {e}")
            time.sleep(5)
